    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-balance font-heading mb-6">
            Dubai's Premier Mobile App Development
          </h1>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-muted-foreground max-w-3xl">
          ...
          <h2 className="mt-8 sm:mt-10 text-xl sm:text-2xl font-bold">Differentiators</h2>
          <ul className="mt-4 list-disc pl-5 sm:pl-6 space-y-2 text-sm sm:text-base text-muted-foreground">
          ...
          <h2 className="mt-8 sm:mt-10 text-xl sm:text-2xl font-bold">Dubai FAQs</h2>
